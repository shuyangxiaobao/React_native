        ...
        return (
           <View style={stylesxlp.container}>
            ...
            // 设为true时，当文本被按下会没有任何视觉效果。默认情况下，文本被按下时会有一个灰色的、椭圆形的高光。
                ...
                >abcdefgfYYjkjUIII888jjjJJJtyuiouytruiouytruio123456789087654323456789098765432345678
...
//1.外面包装一层view，来使里面的文字居中对齐。
    ...
    //字体粗细 ('normal', 'bold', '100', '200', '300', '400', '500', '600', '700', '800', '900')
        fontWeight:"bold", 
        color:"#424242",  //字体颜色
        fontStyle:"normal",  //  字体样式 normal, italic(斜体)
...
// 主轴方向 flexDirection: column(列)    row(行) column-reverse  row   row-reversr
//主轴对齐方式  justifyContent: baseline center flex-end flex-start stretch
