...
export default class NewsNews extends Component<Props> {
    ...
    onNewsClick(rowData) {
        if (this.props.newsClickCallBack) {
            this.props.newsClickCallBack(this.state.baseIP + rowData.htmlFive + "?id=" + rowData.id);
        }
    }
    ...
    renderRow(rowData, sectionID, rowID, highlightRow) {
        ...
        if (rowID == 0) {
            ...
            return (
                ...
                <Image source={{uri:this.state.baseIP+rowData.url}} style={styles.imge1Stye}>
