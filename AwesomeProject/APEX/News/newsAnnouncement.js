...
export default class NewsAnnouncement extends Component<Props> {
        ...
        this.state =
            {
                ...
                base_url: "http://mapp.asiapacificex.com/mobile/data/query?businessType=3&pageNum=1&pageSize=10",
    ...
    renderRow(rowData, sectionID, rowID, highlightRow) {
        ...
        return (
            ...
            >
                ...
                <Image source={require('../image/PDF.png')} style={styles.pdfStyle}></Image>
