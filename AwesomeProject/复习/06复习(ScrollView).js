...
export default class Text1 extends Component<Props> {
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            // 滚动动画开始时调用此函数
            onMomentumScrollStar={()=>{this.onMomentumScrollStar()}}
    ...
    renderChildView(){
        //数组
        var allChild = [];
        var colors = ['red','green','blue','yellow','orange','purple','red','green','blue','yellow','orange','purple','#000000'];
        //遍历
        for(var i=0;i<colors.length;i++){
            allChild.push(
                <View key={i}
                      style={{backgroundColor:"#21212B",            width:SCREENWIDTH,
                        height:116,
                ...
                >
                    <View style={{  
                        ...
                        >
                            ...
                            >Introduction to Delivery Process of APEX fo And SHFE FU [CHINESE]
                            </Text>
                        </View>

                        <View style={styles.BottomStyle}>
                            <Text style={styles.timeStyle}
                            >2019-05-23 09:36</Text>

                            <Text style={styles.readAmountStyle}
                            >4859浏览</Text>
                            <TextInput
